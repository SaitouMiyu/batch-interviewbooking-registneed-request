...
@Component( "interviewbookingRegistneedFactoryForRecop" )
public class InterviewbookingRegistneedFactoryForRecop
{
...
//    private String starttime;
    ...
    public RecopDatabase createDatabase()
    {
       return new RecopDatabase( address, port, name, userid, password );
    }
